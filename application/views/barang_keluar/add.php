    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="tanggal_keluar">Tanggal Peminjaman</label>
                    <div class="col-md-5">
                        <input value="<?= set_value('tanggal_keluar', date("Y-m-d H:i:s")); ?>" name="tanggal_keluar" id="tanggal_keluar" step="1" type="datetime-local" class="form-control" placeholder="Tanggal Masuk...">
                        <?= form_error('tanggal_keluar', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="nama_peminjam">Nama Peminjam</label>
                    <div class="col-md-5">
                        <input value="<?= set_value('nama_peminjam'); ?>" name="nama_peminjam" id="nama_peminjam" type="text" class="form-control" placeholder="Nama Peminjam...">
                        <?= form_error('nama_peminjam', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                        ...
                        <div class="input-group">
                            <select name="barang_id" id="barang_id" class="custom-select">
                                ...
                                <?php foreach ($barang as $b) : ?>
                                    <option value="<?= $b['id_barang'] ?>"><?= $b['kode_bmn'] . ' | ' . $b['nama_barang'] ?></option>
                                <?php endforeach; ?>
                            </select>
