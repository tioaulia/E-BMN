    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="kode_bmn">Kode BMN</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('kode_bmn', $barang['kode_bmn']); ?>" name="kode_bmn" id="kode_bmn" type="text" class="form-control" placeholder="Nama Barang...">
                        <?= form_error('kode_bmn', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="gambar">Gambar</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('gambar', $barang['gambar']); ?>" name="gambar" id="gambar" type="file" class="form-control">
                        <?= form_error('gambar', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="tahun_perolehan">Tahun Perolehan</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('tahun_perolehan', $barang['tahun_perolehan']); ?>" name="tahun_perolehan" id="tahun_perolehan" type="date" class="form-control" placeholder="Nama Barang...">
                        <?= form_error('tahun_perolehan', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="detail">Spesifikasi</label>
                    <div class="col-md-9">
                        <textarea value="<?= set_value('detail', $barang['detail']); ?>" name="detail" id="detail" type="text" class="form-control" placeholder="Spesifikasi...">
