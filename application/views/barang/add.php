        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?php echo base_url('barang') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('stok'); ?>" name="stok" id="stok" type="text" class="form-control" placeholder="Stoke...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('kode_bmn'); ?>" name="kode_bmn" id="kode_bmn" type="text" class="form-control" placeholder="Kode BMN...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('tahun_perolehan'); ?>" name="tahun_perolehan" id="tahun_perolehan" type="date" class="form-control" placeholder="Nama Barang...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <textarea value="<?= set_value('detail'); ?>" name="detail" id="detail" class="form-control"></textarea>
